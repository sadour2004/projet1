...
import { getOptimizedTopProducts } from '@/lib/services/optimized-analytics'
...
export async function GET(req: NextRequest) {
  try {
    ...
    const topProducts = await getOptimizedTopProducts(limit, {
    ...
    logger.error('GET /api/analytics/top-products error', { error })
